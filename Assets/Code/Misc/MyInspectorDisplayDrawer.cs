...
namespace Cysharp.Threading.Tasks
{
    ...
    public class InspectorDisplayAttribute : PropertyAttribute
    {
        ...
        public InspectorDisplayAttribute(string fieldName = "latestValue", bool notifyPropertyChanged = true) {
            FieldName = fieldName;
    ...
    [UnityEditor.CustomPropertyDrawer(typeof(IntAsyncReactiveProperty))]
    ...
    public class InspectorDisplayDrawer : UnityEditor.PropertyDrawer
    {
        public override void OnGUI(Rect position, UnityEditor.SerializedProperty property, GUIContent label) {
            ...
            bool notifyPropertyChanged;
            {
                ...
                fieldName = (attr == null) ? "latestValue" : attr.FieldName;
        ...
        object GetValueRecursive(object obj, int index, string[] paths) {
            ...
            while (fldInfo == null) {
                ...
                if (fldInfo != null ||
                    type.BaseType == null ||
                    type.BaseType.IsSubclassOf(typeof(AsyncReactiveProperty<>))) break;
        ...
        public override float GetPropertyHeight(SerializedProperty property, GUIContent label) {
            var attr = this.attribute as InspectorDisplayAttribute;
            var fieldName = (attr == null) ? "latestValue" : attr.FieldName;
